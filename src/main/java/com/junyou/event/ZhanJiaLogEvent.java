 ...
 * 
 */
public class ZhanJiaLogEvent extends AbsGameLogEvent {
    ...
    public ZhanJiaLogEvent(int type, Long userRoleId, Integer consumeMoney, Integer consumeGold, JSONArray consumeItem, int beginLevel, int endLevel, int oldZfzVal, int newZfzVal) {
        super(type);
