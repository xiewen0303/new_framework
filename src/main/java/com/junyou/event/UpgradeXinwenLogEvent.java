 ...
 * @date 2015-6-5
 */
public class UpgradeXinwenLogEvent extends AbsGameLogEvent {
	...
	public UpgradeXinwenLogEvent(long userRoleId, JSONArray consumeItem,
			int jie, int ceng) {
		super(LogPrintHandle.TANGBAO_XINWEN_LOG);
