 ...
 *@Version 1.1.0
 */
public class QiLingLogEvent extends AbsGameLogEvent {
    ...
    public QiLingLogEvent(int type, Long userRoleId, Integer consumeMoney, Integer consumeGold, JSONArray consumeItem, int beginLevel, int endLevel, int oldZfzVal, int newZfzVal) {
        super(type);
