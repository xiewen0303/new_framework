 ...
 * @date 2016-11-29
 */
public class ShenQiJinJieLogEvent extends AbsGameLogEvent {

    private static final long serialVersionUID = 1L;
    
    private Long userRoleId;
    private int shenQiId;//神器Id
    ...
    public ShenQiJinJieLogEvent(int type,int shenQiId, Long userRoleId, Integer consumeMoney, Integer consumeGold, JSONArray consumeItem, int beginLevel, int endLevel, int oldZfzVal, int newZfzVal) {
        super(type);
