 ...
 * 
 */
public class ChiBangLogEvent extends AbsGameLogEvent {
    ...
    public ChiBangLogEvent(int type, Long userRoleId, Integer consumeMoney, Integer consumeGold, JSONArray consumeItem, int beginLevel, int endLevel, int oldZfzVal, int newZfzVal) {
        super(type);
