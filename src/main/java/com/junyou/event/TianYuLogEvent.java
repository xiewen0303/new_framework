 ...
 *@Version 1.1.0
 */
public class TianYuLogEvent extends AbsGameLogEvent {
    ...
    public TianYuLogEvent(int type, Long userRoleId, Integer consumeMoney, Integer consumeGold, JSONArray consumeItem, int beginLevel, int endLevel, int oldZfzVal, int newZfzVal) {
        super(type);
