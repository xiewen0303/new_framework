 ...
 */
public class JianShangFormula extends AbsAttributeFormula implements IAttributeFormula{

	@Override
	public void refreshAttribute(IFightAttribute destination) {
		long value = destination.getEffectAttribute(EffectType.x27.name());
		destination.setJianShang(value);
	}
