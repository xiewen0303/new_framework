...
public class MaiguFubenStagePosition extends AbsRolePosition {
	...
	public MaiguFubenStagePosition(Long roleId, Integer mapId, Integer mapType, Integer x, Integer y, Integer fubenId, Integer teamId) {
		
		this(roleId, "maigu_"+teamId.toString(), mapId, mapType, x, y, fubenId);
	}
	
	public MaiguFubenStagePosition(Long roleId,String stageId, Integer mapId, Integer mapType, Integer x, Integer y, Integer fubenId){
	...
	public int getPostionType() {
		return PostionType.MAIGU_COPY_POSITION;
	}
