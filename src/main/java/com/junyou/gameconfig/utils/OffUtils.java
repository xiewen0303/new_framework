...
//		if(maxScope > MAX_SEARCH_STEP){
//			maxScope = MAX_SEARCH_STEP;
//		}
//		
//		Map<Integer, Map<String, LayerPoint>> allLayersMap = null;
//		switch (pathFinderType) {
//		case A:
//			allLayersMap = ( (center.getX() & 1) > 0) ? allLayersMap1 : allLayersMap0;
//			break;
//		case AExtend:
//			allLayersMap = allLayersMap2;
//			break;
//		default:
//			break;
//		}
//		
//		String offKey = getKey(cur, center);
//		for(int i = maxScope; i >= 0; i--){
//			
//			Map<String, LayerPoint> layerMap = allLayersMap.get(i);
//			if(null == layerMap) return true;
//			if(layerMap.containsKey(offKey)) return true;
//			
//		}
//		return false;
	...
	private static String getKey(PointConfig cur,PointConfig center){
		return new StringBuffer().append(cur.getX()-center.getX()).append(",").append(cur.getY()-center.getY()).toString();
	}
